...
function SocialLoginButtons(props) {
    ...
    const loginWithSocial = async (provider) => {
        ...
        console.log(response_social_login)
    ...
    return (
        <>
            ...
            <div className="social-media-buttons d-flex justify-content-evenly">

                <div
                    onClick={() => {
                    loginWithSocial(facebookProvider).then(r => {
                        console.log(r)
                    })}} className="item d-flex align-items-center facebook">
                    <i onClick={props.postSocialLogin} className='bx bxl-facebook'></i>
                    <p onClick={props.postSocialLogin} >Facebook</p>
                </div>
                ...
                }} className="item d-flex align-items-center github">
                    <i onClick={props.postSocialLogin}  className='bx bxl-github'></i>
                    <p onClick={props.postSocialLogin}  >Github</p>
                </div>
                ...
                }} className="item d-flex align-items-center google">
                    <i onClick={props.postSocialLogin} className='bx bxl-google'></i>
                    <p onClick={props.postSocialLogin} > Google</p>
                </div>
