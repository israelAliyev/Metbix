...
public class LoggedOutJwtTokenCache {
    ...
    private final ExpiringMap<String, OnAccountLogoutSuccessEvent> tokenEventMap;
    ...
    public void markLogoutEventForToken(OnAccountLogoutSuccessEvent event) {
    ...
    public OnAccountLogoutSuccessEvent getLogoutEventForToken(String token) {
